...
$(document).ready(function () {
    ...
    $("#form").validate({
        ...
        messages: {
            NombreCategoria: "(Campo requerido)"
    ...
    tabladata = $('#tbdata').DataTable({
        ...
        "columns": [/* Campos de la tabla categoria    */
            { "data": "iD_Categoria", "width": "25%" },
            { "data": "nombreCat", "width": "25%" },
...
function abrirPopUpForm(json) {
    ...
    if (json != null) {
        ...
        $("#txtNombreCategoria").val(json.nombreCat);
    ...
    if ($("#form").valid()) {
        ...
        var request = {
            objeto: {
                ...
                nombreCat: ($("#txtNombreCategoria").val() != "" ? $("#txtNombreCategoria").val() : ""),
