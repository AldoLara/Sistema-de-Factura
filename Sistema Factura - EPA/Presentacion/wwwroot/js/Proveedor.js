...
$(document).ready(function () {
    ...
    $("#form").validate({
        ...
        messages: {
            NombreProveedor: "(Este campo obligatorio)",
            DireccionProveedor: "(Este campo obligatorio)",
            TelefonoProveedor: "(Este campo obligatorio)"
        },
        errorElement: 'span'
    });
    ...
    tabladata = $('#tbdata').DataTable({
        ...
        "columns": [/* Campos de la tabla proveedor    */
...
function abrirPopUpForm(json) {
    ...
    if (json != null) {
        ...
        $("#txtNombreProveedor").val(json.nombre);
        $("#txtDireccionProveedor").val(json.direccion);
        $("#txtTelefonoProveedor").val(json.telefono);
