...
$(document).ready(function () {
    ...
    tabladata = $('#tbdata').DataTable({
        ...
        "columns": [
            ...
            {
                "data": "objSuministro", render: function (data) {
                    return data.fechaCaducidad
                }
            },
            {
                "data": "objSuministro", render: function (data) {
                    return "C$./ " + parseFloat(data.precioCompra).toFixed(2).replace(/\B(?=(\d{3})+(\.|$))/g, ",");
            ...
            {
                "data": "objProdBebida", render: function (data) {
...
function abrirPopUpForm(json) {
    ...
    if (json != null) {
        ...
        $("#txtCorreo").val("");
        $("#txtClave").val("");
        $("#ddlRol").val($("#ddlRol option:first").val());
        $("#cboEstado").val();
