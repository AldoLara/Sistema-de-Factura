...
{
    public partial class CambiarNombreTablas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Salario = table.Column<decimal>(type: "decimal(13,2)", nullable: false),
                    EstadoContrato = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmpleadosClaims", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmpleadosLogins", x => new { x.LoginProvider, x.ProviderKey });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmpleadosTokens", x => new { x.UserId, x.LoginProvider, x.Name });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmpleadosRoles", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
